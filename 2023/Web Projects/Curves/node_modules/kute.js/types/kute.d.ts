...
declare module "kute.js/src/components/svgMorph" {
     ...
     */
    function getPolygon(input: import("kute.js").polygonMorph | string, maxSegmentLength: number): import("kute.js").polygonMorph;
    /**
     * Checks the validity of a polygon.
     * @param {KUTE.polygonMorph} polygon the target polygon
     * @returns {boolean} the result of the check
     */
    function validPolygon(polygon: import("kute.js").polygonMorph): boolean;
    /**
     ...
     */
    function getInterpolationPoints(path1: string, path2: string, precision: number): import("kute.js").polygonMorph[];
    /**
     ...
     */
    function rotatePolygon(polygon: import("kute.js").polygonMorph, vs: import("kute.js").polygonMorph): void;
    import pathToString from "svg-path-commander/src/convert/pathToString";
    import pathToCurve from "svg-path-commander/src/convert/pathToCurve";
...
declare module "kute.js/src/tween/tweenCollection" {
    ...
    export default class TweenCollection {
         ...
         */
        constructor(els: Element[] | HTMLCollection | NodeList, vS: import("kute.js").tweenProps, vE: import("kute.js").tweenProps, Options: KUTE.tweenOptions);
        /** @type {KUTE.twCollection[]} */
        tweens: import("kute.js").twCollection[];
        /** @type {number?} */
        length: number | null;
        /**
...
declare module "kute.js/src/interface/allFromTo" {
     ...
     * @returns {TweenCollection} the Tween object collection
     */
    export default function allFromTo(elements: Element[] | HTMLCollection | NodeList, startObject: import("kute.js").tweenProps, endObject: import("kute.js").tweenProps, optionsObj: KUTE.tweenOptions): TweenCollection;
...
declare module "kute.js/src/interface/allTo" {
     ...
     * @returns {TweenCollection} the Tween object collection
     */
    export default function allTo(elements: Element[] | HTMLCollection | NodeList, endObject: import("kute.js").tweenProps, optionsObj: import("kute.js").tweenProps): TweenCollection;
    import TweenCollection from "kute.js/src/tween/tweenCollection";
}
declare module "kute.js/src/interface/fromTo" {
     ...
     */
    export default function fromTo(element: Element, startObject: import("kute.js").tweenProps, endObject: import("kute.js").tweenProps, optionsObj: KUTE.tweenOptions): KUTE.Tween;
}
declare module "kute.js/src/interface/to" {
     ...
     * @returns {KUTE.Tween} the resulting Tween object
     */
    export default function to(element: Element, endObject: import("kute.js").tweenProps, optionsObj: KUTE.tweenOptions): KUTE.Tween;
}
...
declare module "kute.js/src/tween/tweenBase" {
    ...
    export default class TweenBase {
         ...
         */
        constructor(targetElement: Element, startObject: import("kute.js").tweenProps, endObject: import("kute.js").tweenProps, opsObject: KUTE.tweenOptions);
        element: Element;
        /** @type {boolean} */
        playing: boolean;
        /** @type {number?} */
        ...
        /** @type {boolean} */
        _startFired: boolean;
        valuesEnd: import("kute.js").tweenProps;
        valuesStart: import("kute.js").tweenProps;
        _resetStart: any;
...
declare module "kute.js/src/tween/tween" {
    ...
    export default class Tween extends TweenBase {
        ...
        valuesRepeat: import("kute.js").tweenProps;
        /** @type {boolean} */
        _yoyo: boolean;
        /** @type {boolean} */
        _reversed: boolean;
